...
- 18ee1cb: Point the People cookbook to the maintained cookbook contribution guide.
...
- b733f91: Remove unused `react-router-dom` dependency. Imports already use `@equinor/fusion-framework-react-router`.
