...
export const LandingSheetContent = ({ setSheet }: SheetContentProps) => {
    return (
        <section>
            <div>
                <div>
                    <Button variant="ghost" onClick={() => setSheet('allocations')}>
                        <Icon name="work_outline"></Icon>
                        My Allocations
                    </Button>
                </div>
                <div>
                    <Button variant="ghost" onClick={() => setSheet('roles')}>
                        <Icon name="security"></Icon>
                        My Roles
                    </Button>
                </div>
                <div>
                    <Button variant="ghost" onClick={() => setSheet('features')}>
            ...
            <Divider></Divider>
            <div>
                <Button variant="ghost" href="https://delve.microsoft.com" target="_blank">
