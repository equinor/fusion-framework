...
/**
 * API version identifiers `getAppBundleArchiveAtVersion` accepts for `GET
 ...
 * {@link GetAppBundleArchiveAtVersionArg} and {@link GetAppBundleArchiveAtVersionResponse}.
 */
type GetAppBundleArchiveAtVersionVersion = FilterAllowedApiVersions<AvailableVersions>;

/**
 * Version contract for `getAppBundleArchiveAtVersion`, implementing `GET
 * /bundles/apps/{appIdentifier}@{versionIdentifier}`.
 *
...
const VersionContract = {
  [ApiVersion.v1]: {
    ...
    args: z
      ...
      .describe(
        'Arguments for GET /bundles/apps/{appIdentifier}@{versionIdentifier} (getAppBundleArchiveAtVersion v1.0).',
      ),
...
/**
 * Response body `getAppBundleArchiveAtVersion` resolves for the selected API version.
 *
 ...
 */
type GetAppBundleArchiveAtVersionResponse<TVersion extends GetAppBundleArchiveAtVersionVersion> =
  VersionedResponse<typeof VersionContract, ExtractApiVersion<TVersion>>;

/**
 * Arguments `getAppBundleArchiveAtVersion` accepts, resolved from the selected API version.
 *
 ...
 */
type GetAppBundleArchiveAtVersionArg<TVersion extends GetAppBundleArchiveAtVersionVersion> =
  VersionedArgs<typeof VersionContract, ExtractApiVersion<TVersion>>;

/**
 * What `getAppBundleArchiveAtVersion` hands back once the request runs, for the selected API
 * version and client method.
 *
 * `'json'` gives `Promise<GetAppBundleArchiveAtVersionResponse<TVersion>>` and `'json$'` gives
 * `StreamResponse<GetAppBundleArchiveAtVersionResponse<TVersion>>`, so promise and observable
 * callers share one response type.
 */
type GetAppBundleArchiveAtVersionResult<
  TVersion extends GetAppBundleArchiveAtVersionVersion,
  TMethod extends ClientMethodType = 'json',
> = ClientMethod<GetAppBundleArchiveAtVersionResponse<TVersion>>[TMethod];
  ...
  switch (version) {
    case ApiVersion.v1: {
      const baseInit: FetchRequestInit<
        GetAppBundleArchiveAtVersionResponse<ApiVersion.v1>,
        JsonRequest
      > = {
 ...
 * for app build."
 *
 * Curried in two stages: `getAppBundleArchiveAtVersion(version, client, method)` binds the API
 ...
 * {@link GetAppBundleArchiveAtVersionArg} plus an optional `ClientRequestInit`, and gives back
 * {@link GetAppBundleArchiveAtVersionResult}.
 *
 ...
 * @returns A request function taking {@link GetAppBundleArchiveAtVersionArg} and an optional
 * `ClientRequestInit`, returning {@link GetAppBundleArchiveAtVersionResult}.
 ...
 * @example
 * ```ts
 * import { getAppBundleArchiveAtVersion } from '@equinor/fusion-services/apps';
 *
 * const result = await getAppBundleArchiveAtVersion('v1', httpClient)({
 *   appIdentifier: 'my-app',
 *   versionIdentifier: '1.2.3',
 * });
 * ```
 */
const getAppBundleArchiveAtVersion = <
  TVersion extends GetAppBundleArchiveAtVersionVersion,
  TMethod extends ClientMethodType = 'json',
>(
  version: TVersion,
  ...
  return (
    input: GetAppBundleArchiveAtVersionArg<MethodVersion>,
    init?: ClientRequestInit<IHttpClient, GetAppBundleArchiveAtVersionResponse<MethodVersion>>,
  ): GetAppBundleArchiveAtVersionResult<MethodVersion, TMethod> => {
    const args = parseVersionedArgs(VersionContract, apiVersion, input);
    return client[method](
      generateApiPath(apiVersion, args),
      generateRequestParameters(apiVersion, args, init),
    ) as GetAppBundleArchiveAtVersionResult<MethodVersion, TMethod>;
  };
};
