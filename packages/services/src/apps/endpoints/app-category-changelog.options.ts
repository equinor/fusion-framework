...
/**
 * API version identifiers `checkAppCategoryChangelogAccess` accepts for `OPTIONS
 ...
 * {@link CheckAppCategoryChangelogAccessArg} and {@link CheckAppCategoryChangelogAccessResponse}.
 */
type CheckAppCategoryChangelogAccessVersion = FilterAllowedApiVersions<AvailableVersions>;

/**
 * Version contract for `checkAppCategoryChangelogAccess`, implementing `OPTIONS
 * /apps/categories/{appCategoryIdentifier}/changelog`.
 *
...
const VersionContract = {
  [ApiVersion.v1]: {
    ...
    args: z
      ...
      .describe(
        'Arguments for OPTIONS /apps/categories/{appCategoryIdentifier}/changelog (checkAppCategoryChangelogAccess v1.0).',
      ),
...
/**
 * Response body `checkAppCategoryChangelogAccess` resolves for the selected API version.
 *
...
type CheckAppCategoryChangelogAccessResponse<
  TVersion extends CheckAppCategoryChangelogAccessVersion,
> = VersionedResponse<typeof VersionContract, ExtractApiVersion<TVersion>>;

/**
 * Arguments `checkAppCategoryChangelogAccess` accepts, resolved from the selected API version.
 *
 ...
 */
type CheckAppCategoryChangelogAccessArg<TVersion extends CheckAppCategoryChangelogAccessVersion> =
  VersionedArgs<typeof VersionContract, ExtractApiVersion<TVersion>>;

/**
 * What `checkAppCategoryChangelogAccess` hands back once the request runs, for the selected API
 * version and client method.
 *
 * `'json'` gives `Promise<CheckAppCategoryChangelogAccessResponse<TVersion>>` and `'json$'` gives
 * `StreamResponse<CheckAppCategoryChangelogAccessResponse<TVersion>>`, so promise and observable
 * callers share one response type.
 */
type CheckAppCategoryChangelogAccessResult<
  TVersion extends CheckAppCategoryChangelogAccessVersion,
  TMethod extends ClientMethodType = 'json',
> = ClientMethod<CheckAppCategoryChangelogAccessResponse<TVersion>>[TMethod];
  ...
  switch (version) {
    case ApiVersion.v1: {
      const baseInit: FetchRequestInit<
        CheckAppCategoryChangelogAccessResponse<ApiVersion.v1>,
        JsonRequest
      > = {
        method: 'OPTIONS',
...
/**
 * Endpoint that returns a response header with allowed http methods for the app category changelog.
 *
 * Fusion Apps API operation: `OPTIONS /apps/categories/{appCategoryIdentifier}/changelog` —
 * "Endpoint that returns a response header with allowed http methods for the app category
 * changelog."
 *
 * Curried in two stages: `checkAppCategoryChangelogAccess(version, client, method)` binds the API
 ...
 * {@link CheckAppCategoryChangelogAccessArg} plus an optional `ClientRequestInit`, and gives back
 * {@link CheckAppCategoryChangelogAccessResult}.
 *
 ...
 * @returns A request function taking {@link CheckAppCategoryChangelogAccessArg} and an optional
 * `ClientRequestInit`, returning {@link CheckAppCategoryChangelogAccessResult}.
 ...
 * @example
 * ```ts
 * import { checkAppCategoryChangelogAccess } from '@equinor/fusion-services/apps';
 *
 * await checkAppCategoryChangelogAccess('v1', httpClient)({
 *   appCategoryIdentifier: 'productivity',
 * });
 * ```
 */
const checkAppCategoryChangelogAccess = <
  TVersion extends CheckAppCategoryChangelogAccessVersion,
  TMethod extends ClientMethodType = 'json',
>(
  version: TVersion,
  ...
  return (
    input: CheckAppCategoryChangelogAccessArg<MethodVersion>,
    init?: ClientRequestInit<IHttpClient, CheckAppCategoryChangelogAccessResponse<MethodVersion>>,
  ): CheckAppCategoryChangelogAccessResult<MethodVersion, TMethod> => {
    const args = parseVersionedArgs(VersionContract, apiVersion, input);
    return client[method](
      generateApiPath(apiVersion, args),
      generateRequestParameters(apiVersion, args, init),
    ) as CheckAppCategoryChangelogAccessResult<MethodVersion, TMethod>;
  };
};
