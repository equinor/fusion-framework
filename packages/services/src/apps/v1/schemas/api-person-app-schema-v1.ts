 ...
 *
 * A Fusion application as seen by a specific user, including whether they have pinned it.
 */
export const ApiPersonAppSchemaV1 = z
  .object({
 ...
 * A Fusion application as seen by a specific user, including whether they have pinned it.
 *
 * Apps API 1.0 model inferred from {@link ApiPersonAppSchemaV1}, so `ApiPersonAppV1` and the
 * runtime validator can never describe different shapes.
 */
export type ApiPersonAppV1 = z.infer<typeof ApiPersonAppSchemaV1>;
