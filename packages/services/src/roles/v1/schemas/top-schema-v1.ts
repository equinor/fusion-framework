...
/**
 * The `$top` pagination option Roles API 1.0 accepts on collection endpoints: 0 through 100
 * records.
 *
 * Roles API 1.0 model inferred from {@link TopSchemaV1}, so `TopV1` and the runtime validator
