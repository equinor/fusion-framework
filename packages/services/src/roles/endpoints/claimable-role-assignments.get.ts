...
const VersionContract = {
  [ApiVersion.v1]: {
    ...
    args: z
      ...
      .describe(
        'Arguments for GET /claimable-roles/{claimableRoleIdentifier}/assignments (listClaimableRoleAssignments v1.0).',
      ),
    /** Response published by version 1.0 of this operation. */
    response: apiPagedCollectionSchemaV1(ApiClaimableRoleAssignmentSchemaV1),
  },
 ...
 */
type ListClaimableRoleAssignmentsResponse<TVersion extends ListClaimableRoleAssignmentsVersion> =
 ...
 */
type ListClaimableRoleAssignmentsArg<TVersion extends ListClaimableRoleAssignmentsVersion> =
...
type ListClaimableRoleAssignmentsResult<
  TVersion extends ListClaimableRoleAssignmentsVersion,
  TMethod extends ClientMethodType = 'json',
> = ClientMethod<ListClaimableRoleAssignmentsResponse<TVersion>>[TMethod];
  ...
  switch (version) {
    case ApiVersion.v1: {
      const baseInit: FetchRequestInit<
        ListClaimableRoleAssignmentsResponse<ApiVersion.v1>,
        JsonRequest
      > = {
 ...
 * ```
 */
const listClaimableRoleAssignments = <
  TVersion extends ListClaimableRoleAssignmentsVersion,
  TMethod extends ClientMethodType = 'json',
>(
  version: TVersion,
  ...
  return (
    input: ListClaimableRoleAssignmentsArg<MethodVersion>,
    init?: ClientRequestInit<IHttpClient, ListClaimableRoleAssignmentsResponse<MethodVersion>>,
  ): ListClaimableRoleAssignmentsResult<MethodVersion, TMethod> => {
    const args = parseVersionedArgs(VersionContract, apiVersion, input);
    return client[method](
      generateApiPath(apiVersion, args),
      generateRequestParameters(apiVersion, args, init),
    ) as ListClaimableRoleAssignmentsResult<MethodVersion, TMethod>;
  };
};
