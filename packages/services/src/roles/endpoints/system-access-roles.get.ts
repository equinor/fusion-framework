...
type ListSystemAccessRolesResult<
  ...
  TResult = ListSystemAccessRolesResponse<TVersion>,
...
>(
  ...
  return <
    TResponse = ListSystemAccessRolesResponse<MethodVersion>,
    TResult = ListSystemAccessRolesResult<MethodVersion, TMethod, TResponse>,
  >(
