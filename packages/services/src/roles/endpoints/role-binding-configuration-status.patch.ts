...
> = ClientMethod<UpdateRoleBindingConfigurationStatusResponse<TVersion>>[TMethod];
...
>(
  ...
  return (
    ...
    init?: ClientRequestInit<
      IHttpClient,
      UpdateRoleBindingConfigurationStatusResponse<MethodVersion>
    >,
  ): UpdateRoleBindingConfigurationStatusResult<MethodVersion, TMethod> => {
    const args = parseVersionedArgs(VersionContract, apiVersion, input);
    return client[method](
      generateApiPath(apiVersion, args),
      generateRequestParameters(apiVersion, args, init),
    ) as UpdateRoleBindingConfigurationStatusResult<MethodVersion, TMethod>;
  };
};
