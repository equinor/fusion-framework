...
type DeleteRoleAssignmentsResult<
  ...
  TResult = DeleteRoleAssignmentsResponse<TVersion>,
...
>(
  ...
  return <
    TResponse = DeleteRoleAssignmentsResponse<MethodVersion>,
    TResult = DeleteRoleAssignmentsResult<MethodVersion, TMethod, TResponse>,
  >(
