...
type CreateClaimableRoleResult<
  ...
  TResult = CreateClaimableRoleResponse<TVersion>,
...
>(
  ...
  return <
    TResponse = CreateClaimableRoleResponse<MethodVersion>,
    TResult = CreateClaimableRoleResult<MethodVersion, TMethod, TResponse>,
  >(
