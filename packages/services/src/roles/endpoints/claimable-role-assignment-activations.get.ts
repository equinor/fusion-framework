...
type ListClaimableRoleAssignmentActivationsResult<
  ...
  TResult = ListClaimableRoleAssignmentActivationsResponse<TVersion>,
...
>(
  ...
  return <
    TResponse = ListClaimableRoleAssignmentActivationsResponse<MethodVersion>,
    TResult = ListClaimableRoleAssignmentActivationsResult<MethodVersion, TMethod, TResponse>,
  >(
