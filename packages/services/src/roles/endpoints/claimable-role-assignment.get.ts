...
const VersionContract = {
  [ApiVersion.v1]: {
    ...
    args: z
      ...
      .describe(
        'Arguments for GET /claimable-roles/{claimableRoleIdentifier}/assignments/{claimableRoleAssignmentId} (getClaimableRoleAssignment v1.0).',
      ),
 ...
 * runtime.
 */
type GetClaimableRoleAssignmentResponse<TVersion extends GetClaimableRoleAssignmentVersion> =
 ...
 */
type GetClaimableRoleAssignmentArg<TVersion extends GetClaimableRoleAssignmentVersion> =
  ...
  switch (version) {
    case ApiVersion.v1: {
      const baseInit: FetchRequestInit<
        GetClaimableRoleAssignmentResponse<ApiVersion.v1>,
        JsonRequest
      > = {
 ...
 * ```
 */
const getClaimableRoleAssignment = <
  TVersion extends GetClaimableRoleAssignmentVersion,
  TMethod extends ClientMethodType = 'json',
>(
  version: TVersion,
