...
> = ClientMethod<CreateRoleBindingConfigurationHistoryRecordResponse<TVersion>>[TMethod];
...
>(
  ...
  return (
    ...
    init?: ClientRequestInit<
      IHttpClient,
      CreateRoleBindingConfigurationHistoryRecordResponse<MethodVersion>
    >,
  ): CreateRoleBindingConfigurationHistoryRecordResult<MethodVersion, TMethod> => {
    const args = parseVersionedArgs(VersionContract, apiVersion, input);
    return client[method](
      generateApiPath(apiVersion, args),
      generateRequestParameters(apiVersion, args, init),
    ) as CreateRoleBindingConfigurationHistoryRecordResult<MethodVersion, TMethod>;
  };
};
