...
const VersionContract = {
  [ApiVersion.v1]: {
    ...
    args: z
      ...
      .describe(
        'Arguments for GET /role-binding-configurations/{identifier}/history (listRoleBindingConfigurationHistory v1.0).',
      ),
  ...
  switch (version) {
    case ApiVersion.v1: {
      const baseInit: FetchRequestInit<
        ListRoleBindingConfigurationHistoryResponse<ApiVersion.v1>,
        JsonRequest
      > = {
 ...
 * ```
 */
const listRoleBindingConfigurationHistory = <
  TVersion extends ListRoleBindingConfigurationHistoryVersion,
  TMethod extends ClientMethodType = 'json',
>(
  version: TVersion,
