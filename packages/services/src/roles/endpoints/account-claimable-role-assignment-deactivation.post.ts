...
type DeactivateClaimableRoleAssignmentResult<
  ...
  TResult = DeactivateClaimableRoleAssignmentResponse<TVersion>,
...
>(
  ...
  return <
    TResponse = DeactivateClaimableRoleAssignmentResponse<MethodVersion>,
    TResult = DeactivateClaimableRoleAssignmentResult<MethodVersion, TMethod, TResponse>,
  >(
