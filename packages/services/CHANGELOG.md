...
- 2c7848a: Add the Fusion Apps API 1.0 client as the `@equinor/fusion-services/apps` export.
...
- bec2ce3: Add `@equinor/fusion-services` — tree-shakeable, function-based clients for Fusion platform services, starting with complete Fusion Roles V2 coverage.
