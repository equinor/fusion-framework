...
export class BookmarkClient {
    ...
    #bookmarkAPiClient: IBookmarksClient;
    ...
    public createBookmark(bookmark: NewBookmark<unknown>): Observable<Bookmark<unknown>> {
        return new Observable((subscriber) => {
