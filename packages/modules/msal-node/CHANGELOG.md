...
- f87f4d5: Internal: bump `@azure/msal-node` from 5.6.0 to 6.0.0.
...
- f663b46: Add `MockAuthProvider`, a configurable `IAuthProvider` test double, exported from a new `/mock` subpath (`@equinor/fusion-framework-module-msal-node/mock`).
