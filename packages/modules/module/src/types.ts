...
import type { ModuleEventLevel } from './module-event-level.js';
...
// @todo(#5145) - create a BaseModule which implements this interface
...
export interface Module<TKey extends string, TType, TConfig, TDeps extends Array<AnyModule> = []> {
   ...
   */
  // @todo(#5146) - change return type to `ObservableInput`
  // @todo(#5146) - add reference to `IConfigurationBuilder`
 ...
 *
 * @see {@link ModuleEventLevel}
 */
export { ModuleEventLevel } from './module-event-level.js';
