...
- f663b46: Add `MockTelemetryAdapter` and a `./mock` subpath for asserting on tracked telemetry in tests.
...
- abffa53: Export `TelemetryScope` enum from telemetry module.
