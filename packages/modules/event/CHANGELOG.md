...
- f663b46: Add `EventModuleConfigurator`, a `BaseConfigBuilder`-based configurator with fluent
...
- f663b46: Add `waitForEvent` and `watchEvents` helper utilities and `./operators` subpath.
