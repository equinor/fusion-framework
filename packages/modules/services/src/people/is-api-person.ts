...
const requiredApiPersonAttributes = {
  [ApiVersion.v2]: [
    'azureUniqueId',
    /** TODO(#5160) - has to be more required attributes to identify V2??? */
  ] satisfies Array<keyof ApiPerson<'v2'>>,
  [ApiVersion.v4]: [
    /** TODO(#5160) - has to be more required attributes to identify V4??? */
    'azureUniqueId',
...
export const isApiPerson = <V extends keyof typeof ApiVersion>(version: V) => {
  /** TODO(#5161) add options for more strict check */
