...
- f663b46: Add a purpose-built mock, exported from a new `/mock` subpath (`@equinor/fusion-framework-module-feature-flag/mock`).
...
- f663b46: Use the supported navigation `history` API in the URL feature-flag plugin, avoiding deprecated
