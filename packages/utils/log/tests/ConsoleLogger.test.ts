...
describe('Console logger', () => {
  it('should log debug messages', () => {
    ...
    expect(spy).toHaveBeenCalledWith(chalk(chalk.magenta('MainLogger')), 'This is a debug message');
  });
  ...
  it('should log warning messages', () => {
    ...
    expect(spy).toHaveBeenCalledWith(chalk.bold.magenta('MainLogger'), 'This is a warning message');
  });
  ...
  it('should log error messages', () => {
    ...
    expect(spy).toHaveBeenCalledWith(chalk.bold.magenta('MainLogger'), 'This is an error message');
  });
