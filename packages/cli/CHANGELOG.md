...
- bd43eca: Add a built-in `ffc mock-server` command and a `--mock [endpoint]` flag to `ffc app dev` and
  `ffc app serve`.
...
- @equinor/fusion-framework-dev-portal@10.0.2

## 15.2.6

### Patch Changes

- @equinor/fusion-framework-dev-portal@10.0.1
