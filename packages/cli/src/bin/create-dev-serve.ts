...
import { appProxyPlugin } from '@equinor/fusion-framework-cli/app-proxy-plugin.js';
import { externalPublicPlugin } from '@equinor/fusion-framework-cli/external-public-plugin.js';
