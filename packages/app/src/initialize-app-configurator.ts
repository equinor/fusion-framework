 ...
 *
 * @remarks
 * Extracted so `mockApp` (`@equinor/fusion-framework-app/mock`) can drive the
...
>(
  configurator: AppConfigurator<TModules, TRef['modules'], TEnv>,
  cb: AppModuleInitiator<TModules, TRef, TEnv> | undefined,
