...
await Bun.write(`${out}/color-tokens-light.md`, await convert(
...
await Bun.write(`${out}/color-tokens-dark.md`, await convert(
...
await Bun.write(`${out}/spacing-tokens-spacious.md`, await convert(
...
await Bun.write(`${out}/spacing-tokens-comfortable.md`, await convert(
...
const dynamicRows = (await Promise.all(categories.map(async (cat) => {
...
await Bun.write(`${out}/color-tokens-dynamic.md`,
