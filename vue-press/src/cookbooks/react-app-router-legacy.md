...
This cookbook demonstrates the manual `RouteObject[]` routing approach supported by
`@equinor/fusion-framework-react-router`. Use it when maintaining applications that have not
